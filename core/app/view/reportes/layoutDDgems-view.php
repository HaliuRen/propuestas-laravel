...
<div class="row">
  <div class="col-md-12">
  <h1>Reporte DGEMS Layout Validado Por DGEMS</h1>
      <ol class="breadcrumb">
                         
                            <li>
                 <a href="./?view=/reportes/layoutDDgems"><i class="fa fa-file-text-o"></i> Reporte DGEMS Layout Validado Por DGEMS</a>
                             </li>
...
<div class="row">
    ...
    $propuestas =PropuestasViewData::getReportDbgD($_POST["subsistema"],$_POST["tipoescuela"],$_POST["tipovacante"],$_POST["categoria"]);
                ?>
...
<div class="row">   
    <div class="col-md-3">                      
                <a href="./report/layoutDDgems-xlsx.php?subsistema=<?php echo $_POST["subsistema"]; ?>&tipoescuela=<?php echo $_POST["tipoescuela"];?>&tipovacante=<?php echo $_POST["tipovacante"];?>&categoria=<?php echo $_POST["categoria"];?>" 
