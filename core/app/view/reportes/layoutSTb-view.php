...
<div class="row">
  <div class="col-md-12">
  <h1>Reporte DTBC Layout Validado Por Supervisor</h1>
      <ol class="breadcrumb">
                         
                            <li>
                 <a href="./?view=/reportes/layoutSTb"><i class="fa fa-file-text-o"></i> Reporte DTBC Layout Validado Por Supervisor</a>
                             </li>
