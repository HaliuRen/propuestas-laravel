...
<div id="result"></div>
                ...
                <?php endif;?> 
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="horas" class="form-control" style="width:40px;height:33px" pattern="[0-9]"" VALUE="20" readonly="readonly">
                            </div>
                            <br>
                            <div class="input-group"  style="visibility:hidden;">
                           ...
                           <br>
                            ...
                            <button type="submit" name="btn-submit" id="btn-submit" disabled
                            class="btn btn-primary btn-lg">Agregar Plaza</button>
