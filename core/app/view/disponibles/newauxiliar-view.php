...
<?php
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 >
                             Agregar Plaza Disponible Auxiliar de Supervisión
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                      ...
                      <div class="input-group ">
                         ...
                         <div class="input-group ">
                            ...
                            <br>
                                 ...
                                 <?php if(Core::$user->kind==4||Core::$user->kind==10):?>
                             <div class="input-group ">
           ...
           <?php if(Core::$user->kind==17||Core::$user->kind==18):?>
                          ...
                          <div class="input-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="puesto" class="form-control" value="AUXILIAR DE SUPERVISION" readonly >
                            </div>
                            
                            <div class="input-group"  style="visibility:hidden;">
                                 <span class="input-group-addon"><i   class="fa fa-bars fa-fw"></i></span>
                                 <input type="text" name="tipo" class="form-control" placeholder="Tipo*" Value="A0404480" readonly="readonly" style="visibility:hidden;">   
                            </div>
