...
<?php
  ...
  ?>
                <div class="row">
                    <div class="col-lg-12">
                        <h1 >
                            Agregar Plaza Responsable Plantel
                        </h1>
                        <ol class="breadcrumb">
                            <li>
...
<div id="result"></div> 
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form role="form" method="post" action="./?action=/disponibles/addhoras">
                ...
                <?php if(Core::$user->kind==19):?>
                          ...
                          <?php endif;?>
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="puesto" class="form-control" value="HORAS CLASE" readonly >
                            </div>
                            <br>
                            <div class="input-group ">
                                  <span class="input-group-addon" title="HORAS"><i class="fa fa-bars fa-fw"></i></span>
                                <input type="text" name="horas" class="form-control" style="width:40px;height:33px" pattern="[0-9]{2}" VALUE="30" readonly="readonly">
                            </div>
                            <br>
                            <div class="input-group"  style="visibility:hidden;">
                                 <span class="input-group-addon"><i   class="fa fa-bars fa-fw"></i></span>
                                 <input type="text" name="tipo" class="form-control" placeholder="Tipo*" Value="A0220961" readonly="readonly" style="visibility:hidden;">             
                            </div>
                           <br>
                           ...
                           <br>
                             ...
                             <input type="checkbox" name="validad" required > &nbsp; Validacion Dirección Plantel
                           </div>
                            
                             <br>


                            <button name="btn-submit" id="btn-submit" disabled type="submit" class="btn btn-primary btn-lg">Agregar Plaza</button>
