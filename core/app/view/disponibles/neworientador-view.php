...
<?php
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 >
                            Agregar Plaza Disponible Orientador
                        </h1>
                        <ol class="breadcrumb">
                            <li>
...
<div id="result"></div>
                        ...
                        <div class="input-group ">
                         ...
                         <div class="input-group ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="zona" class="form-control"  value="<?php echo $user=UserData::getById($_SESSION["user_id"])->zona; ?>" readonly onkeyup="mayus(this);">
                            </div>
                            <br>
                      <?php endif;?>
 ...
 <?php if(Core::$user->kind==17||Core::$user->kind==18):?>
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="puesto" class="form-control" value="ORIENTADOR" readonly >
                            </div>
