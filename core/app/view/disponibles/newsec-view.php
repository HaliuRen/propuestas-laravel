...
<?php
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 >
                            Agregar Plaza Disponible de Secretario EScolar
                        </h1>
                        <ol class="breadcrumb">
                            <li>
...
<div id="result"></div>
 ...
 <?php if(Core::$user->kind==17||Core::$user->kind==18):?>
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="puesto" class="form-control" value="SECRETARIO ESCOLAR" readonly >
                            </div>
                            <br>
                            <div class="input-group">
