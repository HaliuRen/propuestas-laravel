...
#resultadorfc.ok {
    background-color: green;
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 >
                            Agregar Plaza Disponible Supervisión
                        </h1>
                        <ol class="breadcrumb">
                            <li>
...
<div id="result"></div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                         ...
                         <div class="input-group ">
                            ...
                            <?php if(Core::$user->kind==4):?>
                             <div class="input-group ">
                                ...
                                <input type="text" name="cct" class="form-control"  value="<?php echo $user=UserData::getById($_SESSION["user_id"])->username; ?>" readonly onkeyup="mayus(this);">
                            </div>
                            <br>
                      ...
                      <?php if(Core::$user->kind==1 || Core::$user->kind==2|| Core::$user->kind==6|| Core::$user->kind==7 
                       || Core::$user->kind==8):?>
                ...
                <?php if(Core::$user->kind==17||Core::$user->kind==18):?>
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="puesto" class="form-control" value="Supervisor" readonly >
                            </div>
                            
                           <div class="input-group"  style="visibility:hidden;">
                                 <span class="input-group-addon"><i   class="fa fa-bars fa-fw"></i></span>
                                 <input type="text" name="tipo" class="form-control" placeholder="Tipo*" Value="A0401800" readonly="readonly" style="visibility:hidden;">             
                            </div>
                             ...
                             <input type="checkbox" name="validad" required > &nbsp; Datos Correctos
                           </div>
                            
                             <br>


                            <button type="submit" class="btn btn-primary btn-lg" name="btn-submit" id="btn-submit" disabled>Agregar Plaza</button>
