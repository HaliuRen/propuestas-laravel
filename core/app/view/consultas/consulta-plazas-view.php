<section class="content">
      <?php 
        ...
        $propuesta = PropuestasViewData::getByEstatusSems($_GET["id"]);
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                  <a href="./?view=/consultas/plazas"><i class="fa fa-cogs"></i> Consulta Plazas</a>
                            </li>
                            <li class="active">
 ...
 <div class="col-sm-5 col-sm-offset-2 col-md-6 col-md-offset-0"> 
          <?php if(Core::$user->kind==10||Core::$user->kind==8):?>   
           ...
           <?php if(Core::$user->kind==2||Core::$user->kind==4||Core::$user->kind==5||Core::$user->kind==6||Core::$user->kind==7):?>
                         ...
                         <div class="input-group ">
                                  <span class="input-group-addon" title="ENTREGA DELEGACION"><i class="fa fa-bars fa-fw"></i></span>
                                <input type="text" name="entrega" class="form-control"   value="<?php echo $propuesta->entrega;?>" readonly="readonly">
                            </div>
                            <br>
